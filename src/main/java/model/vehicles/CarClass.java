...
public class CarClass extends VehicleClass {
    ...
    public CarClass(String id, double speed, de.tudresden.sumo.objects.SumoPosition2D position, SumoColor color, String edgeId, double angle, double departureTime) {
