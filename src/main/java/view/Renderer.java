...
//            group.getChildren().addAll(body, glass, rearGlass, leftLight, rightLight);
        	Node busVisual = this.createBusFromSVG(color);
        	group.getChildren().addAll(busVisual);
...
//            group.getChildren().addAll(body, roof, windshield, rearWindow, lLight, rLight);
        	Node carVisual = this.createCarFromSVG(color);
            group.getChildren().addAll(carVisual);
...
//            group.getChildren().addAll(frame, handleBars, rider, head);
        	Node bikeVisual = this.createBikeFromSVG(color);
        	group.getChildren().addAll(bikeVisual);
